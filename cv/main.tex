...
\PassOptionsToPackage{style=ieee,sorting=ymdnt,uniquename=init,defernumbers=true,maxbibnames=8,minbibnames=3}{biblatex}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Zirui Chen, Ph.D. Candidate}

  \makefield{\faEnvelope[regular]}{\href{mailto:chenzirui@westlake.edu.cn}{\texttt{chenzirui@westlake.edu.cn}}}
  ...
  %% Next line
  \makefield{\faGlobe}{\url{https://czr-gif.github.io/}}
  \makefield{\faGraduationCap}{\href{https://scholar.google.com/citations?user=ccn1aWQAAAAJ}{Google Scholar}}

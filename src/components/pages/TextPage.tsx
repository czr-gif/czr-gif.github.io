        ...
        >
            ...
            {config.pdf && (
                <a
                    href={config.pdf}
                    download
                    className="inline-flex items-center gap-2 mb-6 px-4 py-2 text-sm font-medium rounded-lg border border-accent text-accent hover:bg-accent hover:text-white transition-colors duration-200"
                >
            ...
            <div className="text-neutral-700 dark:text-neutral-600 leading-relaxed">
                <ReactMarkdown
                    ...
                    components={{
                        ...
                        pre: ({ children }) => (
                            <pre className="mb-4 overflow-x-auto rounded-lg bg-neutral-100 dark:bg-neutral-800 p-4 text-sm text-primary">
                                {children}
                            </pre>
                        ),
                        code: ({ children }) => (
